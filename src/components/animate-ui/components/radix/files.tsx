...
import { FolderIcon, FolderOpenIcon, FileIcon, ChevronDown, ChevronUp } from 'lucide-react';
...
function FolderTrigger({
  ...
  return (
    <FolderHeaderPrimitive>
      <FolderTriggerPrimitive className="w-full text-start" onClick={onClick}>
        <FolderHighlightPrimitive>
          <FolderPrimitive className="flex items-center justify-between gap-2 p-2 pointer-events-none">
            ...
            <div className="flex items-center gap-2 text-muted-foreground mr-1">
              ...
              <FolderIconPrimitive
                closeIcon={<ChevronDown className="size-3.5" />}
                openIcon={<ChevronUp className="size-3.5" />}
              />
            </div>
          </FolderPrimitive>
        </FolderHighlightPrimitive>
