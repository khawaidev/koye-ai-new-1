...
interface ShimmeringTextProps {
  ...
  shimmerColor?: string
  /** Alias for shimmerColor */
  shimmeringColor?: string
  /** Enable wave effect (currently same as shimmer) */
  wave?: boolean
}
...
export function ShimmeringText({
  ...
  // Use shimmeringColor if provided, otherwise shimmerColor
  const effectiveShimmerColor = shimmeringColor || shimmerColor
      ...
      style={
        {
          ...
          ...(effectiveShimmerColor && { "--shimmer-color": effectiveShimmerColor }),
