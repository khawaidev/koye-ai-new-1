...
code = code.replace(/bg-primary\/10/g, 'bg-white/5');
code = code.replace(/bg-primary\/20/g, 'bg-white/5');
code = code.replace(/shadow-\[0_0_15px_rgba\(var\(--primary-rgb\),0\.5\)\]/g, 'shadow-sm');
code = code.replace(/shadow-xl shadow-primary\/20/g, 'shadow-sm text-black');
code = code.replace(/shadow-lg shadow-primary\/20/g, 'shadow-sm text-black');
...
code = code.replace(/border-primary/g, 'border-white/20');
...
// Reverting text-white if we replaced it inside classes that specifically need it but mostly they are dark mode text-foreground anyways.

// Sizes - downscaling
code = code.replace(/text-7xl/g, 'text-3xl');
code = code.replace(/text-6xl/g, 'text-2xl');
code = code.replace(/text-5xl/g, 'text-xl');
